...
function MapCard() {
    return (
        <div className='bg-[#425c5a] py-7 flex flex-col items-start justify-start w-[23rem] rounded-2xl'>
            ...
            <div>
            <Image className='w-full h-full mt-10' src={Map} alt="" />
            </div>
            <Tabs defaultValue="account" className="w-full mt-8 bg-[#3d5654] relative">
          <TabsList className="w-full bg-[#3d5654] flex items-start justify-between">
          ...
          <TabsContent className="absolute z-30" value="one-way"><PriceRange /></TabsContent>
