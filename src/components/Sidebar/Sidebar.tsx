...
function Sidebar() {
  ...
  return (
    <div className="w-[250px] cursor-pointer flex flex-col py-12 gap-6 items-start justify-start h-screen rounded-3xl bg-green-900 left-0 top-0 fixed">
      ...
      <div className="flex text-white text-base font-medium flex-col items-start justify-start gap-5 w-full">
        <div className="flex items-start justify-start py-3 px-5 gap-4" onClick={() => router.push("/")}>
          <Box1 variant="Linear" color="#FFD700" size={24} />
          <p className="flex">Dashboard</p>
        </div>
        <div className={`${pathname === "/flights" ? "bg-red-700 py-3 px-5 text-black rounded-l-3xl rounded-tr-3xl rounded-br-3xl" : "bg-none text-white"} py-3 px-5 w-full flex items-start justify-start gap-4 relative`} onClick={() => router.push("/flights")}>
          <Airplane variant="Linear" color="#FFD700" size={24} />
        ...
        <div className="flex items-start justify-start py-3 px-5 gap-4">
          <Wallet variant="Linear" color="#FFD700" size={24} />
        ...
        <div className="flex items-start justify-start py-3 px-5 gap-4">
          <Activity variant="Linear" color="#FFD700" size={24} />
          <p className="flex">Statistics</p>
        </div>
        <div className="flex items-start justify-start py-3 px-5 gap-4">
          <Setting variant="Linear" color="#FFD700" size={24} />
